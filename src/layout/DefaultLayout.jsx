            ...
            <footer >
                <div className="container h-100">
                    <div className="row row-cols-3 h-100 d-flex align-items-center">
                        ...
                        <p className="col d-flex flex-column flex-md-row gap-sm-1">© 2024 WeatherApp <span className="d-none d-md-inline">|</span>   <a href="https://www.linkedin.com/in/danilo-amico-6a6708303/?trk=opento_sprofile_topcard" target="_blank">Danilo Amico</a></p>
